...
export default function PoliticaDePrivacidade() {
    return (
        <div className="content">
            <PageHeader pageTitle="Política de privacidade" />
                ...
                <div className="row">
                    <div className="col-10 offset-1">
                        <div className="text">
                            ...
                            <p>A sua privacidade é importante para nós. É política da <strong>Rock Pixel Marketing e Vendas</strong> respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="https://rockpixel.com.br">Rock Pixel Marketing e Vendas</a>, e outros sites que possuímos e operamos.</p>
                            ...
                            <p>Todas as consultas e links gerados a partir da ferramenta são armazenados em banco de dados para fins de monitoramento de pesquisas, e poderá ser utilizado para ações de marketing realizados pela Rock Pixel Marketing e Vendas, com ações de mensagens por SMS ou por outras plataformas digitais, como por exemplo o Whatsapp. O usuário que utilizar a ferramenta está ciente de que esta ação estará sendo registrada em banco de dados, e já concorda previamente com esta cláusula de registro e possíveis ações de marketing.</p>

                            <h2>Política de Cookies Rock Pixel Marketing e Vendas</h2>
                            ...
                            <ul>
                                <li>
                                    <p>Cookies relacionados à conta</p>
                            ...
                            <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Rock Pixel Marketing e Vendas oferece no site e com caráter enunciativo, mas não limitativo:</p>
                            ...
                            <ul>
                                ...
                                <li>
                                    <p>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Rock Pixel Marketing e Vendas, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</p>
                                </li>
                            </ul>
